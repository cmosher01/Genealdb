...
public class DayTest {
    ...
    void nominal() {
        ...
        assertThat(uut.toString()).isEqualTo("1966-07-03");
    }

    @Test
    void unknown() {
        final Day uut = show(Day.unknownIso(1, 1, 1));
        assertThat(uut.toString()).isEqualTo("XXXX-XX-XX");
    }

    @Test
    void year() {
        final Day uut = show(Day.ofYearIso(1999));
        assertThat(uut.toString()).isEqualTo("1999-XX-XX");
    }
    ...
    void month() {
        ...
        assertThat(uut.toString()).isEqualTo("1999-04-XX");
    }
    ...
    void bc() {
        ...
        assertThat(uut.toString()).isEqualTo("BC 0005-06-07");
    }
    ...
    void julian() {
        ...
        assertThat(uut.toString()).isEqualTo("1732-02-11 (Julian)");
    }
